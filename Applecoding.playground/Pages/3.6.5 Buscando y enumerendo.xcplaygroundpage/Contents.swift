...
compositores[...4] //Me devuelve un ARRAY de un solo lado y me devuelve los primeros 5 primeros elementos.
...
compositores.firstIndex(of: "Hans Zimmer") //Esto nos dice El valor que estamos buscando en que posicion esta en una ARRAY.

let numeros = [1,6,4,7,8,5,7,3,8,6]
numeros.lastIndex(of: 7) // Me busca un valor desde el final.
numeros.firstIndex(of: 7) // Me busca un valor desde el principal.
...
/* ⬆️Este código utiliza un ciclo for-in para recorrer un array de elementos compositores y obtener su índice y valor correspondiente utilizando la función enumerated().
