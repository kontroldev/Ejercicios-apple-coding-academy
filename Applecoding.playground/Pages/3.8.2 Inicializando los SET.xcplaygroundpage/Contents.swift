...
var conjunto2:Set = ["Jonh Williams", "James Horner", "Jerry Goldsmith"]  // Aqui inferimos conjunto2 explicitamente como un SET con ':Set' de lo contrario el sistema me lo infiere como una array.
...
conjunto1.first  // accedemos al primer valor del Set.
conjunto2.first
