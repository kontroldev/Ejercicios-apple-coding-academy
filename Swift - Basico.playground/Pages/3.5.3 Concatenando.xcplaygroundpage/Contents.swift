...
inicio += final      //Tambien podemos usar el operador de agregacion para añadir cadenas, pero en esta caso sumar a la cadena inicio la cadena final.
...
var caracter: Character = "😅"  // Este caso al ser un caracter y estar entre comillas, tenemos que inferirlo y decirle que es un `:Character`, de lo contrario `swift` lo infiere como si fuera una cadena.
