...
/* [[String]]: Esto especifica el tipo de la variable que sera de String.
   [[String]] significa una Array de Arrays de cadenas. En Swift, los corchetes '[]' se utilizan para denotar Arrays, y String indica que cada elemento dentro de las Arrays internas seran de ese tipo cadena.
...
// mismo ejemplo que el caso de arriba pero con tres dimensiones pero en este caso, esta array seran 'Int'.
...
multiArray3 = [[[2,3,4], [5,6]], [[5,4], [2,6,7]]]  // asi hacemos una array de tres dimenasiones. un array principal que esta tiene dos arrays dentro y dentro de esta segundo, hay una tercera array.
