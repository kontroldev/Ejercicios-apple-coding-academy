...
diccionario.count  // '.count' se utiliza para obtener el número de elementos (clave-valor) que hay en un diccionario.
...
diccionario.removeValue(forKey: "nombre") // el '.removeValue' y le asignamos una clave que tenga un valor para eliminarla, y nos devuelve el valor que a eliminado como si fuera una extraccion del valor.
