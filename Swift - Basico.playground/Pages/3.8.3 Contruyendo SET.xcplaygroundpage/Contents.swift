...
/// **UNION DE UN SET
var actionScifiFilms = scifiFilms.union(actionFilms)  // Si lo hacemos de esta manera, nos aseguramos de que no va a ver elementos repetidos, y el SET los descarta.
